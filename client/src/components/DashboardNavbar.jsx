...
const DashboardNavbar = () => {
    ...
    return (
        <>
            <nav className='w-[70vw] border-b-2 border-b-gray-200 bg-white z-30'>
                <div className=' w-full mx-auto flex justify-between items-center py-6 px-6'>
                    ...
                    <div className='navlinks flex gap-6 items-center text-xs 2xl:text-sm text-gray-500 '>
                        ...
                        <NavLink to='/products'>Holdings</NavLink>
                        <NavLink to='/pricing'>Positions</NavLink>
                        <NavLink to='/support'>Funds</NavLink>
